 ...
 class Posts extends Component {
   ...
   render() {
     ...
     <li  key={poster.id} className="image-element-class">
         ...
         <Button id={poster.id} className="top-left" onClick={e => this.moreInfo(e, index)}>MORE INFO</Button>
         <Modal
             ...
             <Grid>
                 <Row className="show-grid">
                   ...
                   <Col xs={6} md={4}>
                     <p> Address: {poster.address} </p>
                     <p> Place rating: {poster.rating} </p>
                     <p> Place name: {poster.name} </p>
                     <p> Place type: {poster.types} </p>
